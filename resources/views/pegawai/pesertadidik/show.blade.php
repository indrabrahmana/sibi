<x-pegawai>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <a href="{{ url('pegawai/peserta-didik') }}" class="btn btn-dark "><i class="fas fa-arrow-left">
                    </i> Kembali</a>
                <div class="card mt-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div>:</div>
                                        <div class="col-md-4">{{ $pesertadidik->sekolah_asal_pendidikan_sebelumnya }}
                                        </div>
                                    </div>
                                </div>
                                <hr>
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div>:</div>
                                        <div class="col-md-4">{{ $pesertadidik->tanggal_ijazah_pendidikan_sebelumnya }}
                                        </div>
                                    </div>
                                </div>
                                <hr>
                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div>:</div>
                                        <div class="col-md-4">{{ $pesertadidik->lama_belajar_pendidikan_sebelumnya }}
                                        </div>
                                    </div>
                                </div>
                                <hr>
                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div>:</div>
                                        <div class="col-md-4">
                                            {{ $pesertadidik->melanjutkan_ke_setelah_selesai_pendidikan }}</div>
                                    </div>
                                </div>
                                <hr>
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div>:</div>
                                        <div class="col-md-4">
                                            {{ $pesertadidik->mulai_bekerja_setelah_selesai_pendidikan }}</div>
                                    </div>
                                </div>
                                <hr>
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div>:</div>
                                        <div class="col-md-4">
                                            {{ $pesertadidik->nama_perusahaan_setelah_selesai_pendidikan }}</div>
                                    </div>
                                </div>
                                <hr>
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <div>:</div>
                                        <div class="col-md-4">{{ $pesertadidik->penghasilan_setelah_selesai_pendidikan }}
                                        </div>
                                    </div>
                                </div>
                                <hr>
