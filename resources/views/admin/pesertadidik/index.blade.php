    ...
    <div class="container-fluid mt-2">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card mt-3">
                    <div class="card-body">
                        <a href="{{ url('admin/peserta-didik/create') }}" class="btn btn-outline-success ">
                                    ...
                                    @foreach ($list_pesertadidik as $pesertadidik)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <x-button.info-button url="admin/peserta-didik"
                                                        id="{{ $pesertadidik->id }}" />

                                                    <x-button.edit-button url="admin/peserta-didik"
                                                        id="{{ $pesertadidik->id }}" />

                                                    <x-button.delete-button url="admin/peserta-didik"
                                                        id="{{ $pesertadidik->id }}" />
                                                </div>
                                            </td>
