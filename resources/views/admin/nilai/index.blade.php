                                ...
                                @foreach ($list_pesertadidik  as $pesertadidik)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="btn-group">
                                                <x-button.info-button url="admin/nilai" id="{{ $pesertadidik->id }}" />

                                                <x-button.edit-button url="admin/nilai" id="{{ $pesertadidik->id }}" />

                                                <x-button.delete-button url="admin/nilai" id="{{ $pesertadidik->id }}" />
                                            </div>
                                        </td>
